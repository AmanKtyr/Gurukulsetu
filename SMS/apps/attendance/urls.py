...
from .views import (
    ...
    staff_attendance_list, submit_staff_attendance
)

urlpatterns = [
    path('attendance_list/', attendance_list, name='attendance_list'),
    path('staff_attendance/', staff_attendance_list, name='staff_attendance_list'),
    ...
    path('submit_staff_attendance/', submit_staff_attendance, name='submit_staff_attendance'),
